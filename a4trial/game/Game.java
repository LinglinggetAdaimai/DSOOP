...
public class Game {
    ...
    public void printRevealed(){
        for(int i = 0 ; i < possibleWords.size(); i++){
            ...
            System.out.printf("%s ", possibleWords.get(i).getWord());
        }
    }
    public void printUnrevealed(){
        for(int i = 0 ; i < unrevealedwords.size(); i++){
            ...
            System.out.printf("%s ", unrevealedwords.get(i));
        }
    }
    ...
    public int processInput(String input) {
        ...
        if (formable(aWord)) {
            if(!(revealedwords.containsKey(aWord))){
                System.out.println("Nice! A new word!");
    ...
    public boolean formable(Word aWord){ return baseword.canForm(aWord); }

    public void quit (){
        System.out.println("Thank you for playing! Bye!");
    }

    public void userWin(){ System.out.println("You've solved every words. Well done!");}
